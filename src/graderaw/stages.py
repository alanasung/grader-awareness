"""Experiment stages for When Models Notice the Grader During Training."""
...
from .graderaw._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(out / "report.json", {"headline": "When Models Notice the Grader During Training", "claims_gated": True})
