import json
from graderaw.reporting.aggregate import aggregate_results, flatten_metrics
from graderaw.reporting.tables import write_tables
from graderaw.reporting.figures import write_caption, write_figures
