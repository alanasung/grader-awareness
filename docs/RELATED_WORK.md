...
This note situates **When Models Notice the Grader During Training** against the mentor-linked literature for
[When Models Notice the Grader During Training](https://github.com/alanasung/grader-awareness).

## Positioning

Detect and intervene on signals that a training grader is present.

The design hypothesis is: Detect and intervene on signals that a training grader is present.
